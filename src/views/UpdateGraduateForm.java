 ...
 * @author vmascareno
 */
public class UpdateGraduateForm extends javax.swing.JFrame {
    ...
    private void bttnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnUpdateActionPerformed
        ...
        if (txtControlNumber.getText().isEmpty()) {
            ...
            try {
                ...
                boolean graduateSaved = graduate.update();

                if (graduateSaved) {
                    JOptionPane.showMessageDialog(
                            this,
                            "Información del egresado actualizada correctamente",
                    ...
                    JOptionPane.showMessageDialog(
                            this,
                            "No se pudo actualizar la información del egresado",
                            "Actualización de egresados",
            ...
            try {
                if (this.txtControlNumber.getText().isEmpty()) {
                    ...
                    if (graduate.getControlNumber() == -1) {
                        ...
                        this.cmbBxCareer.setSelectedItem(graduate.getCareer());
                        this.cmbBxEgresedAt.setSelectedItem(graduate.getEgresedAt());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateGraduateForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
